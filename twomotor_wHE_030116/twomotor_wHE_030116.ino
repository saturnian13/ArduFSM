...
boolean stimResp = false; //determines whether responses are counted during the stim period
const int stimDur = 1000;
const int respDur = 1000; //1500;
const int solTime = 75; //time soleniod valve is open for delivery of water; controls how much water comes out each time
...
String programName = "twomotor_GA1";
...
const int motorSpeed = 100; //speed at which motors move
...
int hallThreshUpper = 920; //Changing the thresholds can alter the exact position at which the motors stop
int hallThreshLower = 920;
